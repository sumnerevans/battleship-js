s.define('s.ui.Component', {
    ...
    load: function () {
        this.items.each(function (item, index, items) {
            item.merge(this.defaults, false);
    ...
    bindEventListeners: function () {
        ...
        this.listeners.each(function (event, handler) {
            if (event === 'scope') {
                return;
            }
    ...
    applyStyles: function () {
        this.style.each(function (styleName, value) {
            switch (typeof value) {
            case 'string':
                val = value;
                break;
    ...
    setLoading: function (val, config) {
        ...
        if (val) { // Set loading
            ...
            this.div.childNodes.each(function (child) {
